...
class Users(UserBase, table=True):
    ...
    password: str | None # Does not have default=None because it is intended that user must explicitly say no password is provided (so it is not a mistake) - For now just used for Anonymous system user (can't login normal way thank's to not having a password)
